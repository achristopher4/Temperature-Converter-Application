...
public class TemperatureConverterFormatting extends JFrame {
    ...
    public TemperatureConverterFormatting() {
        ...
        promptInput.setHorizontalAlignment(SwingConstants.CENTER);
